...
class PlanarFreehandROITool extends ContourSegmentationBaseTool {
    ...
    constructor(toolProps = {}, defaultToolProps = {
        ...
        this._addNewAnnotationFromLoad = (
            element,
            { worldPoints, metadata, neg, SegmentNumber, segmentationId, cachedStats, closed = false }
        ) => {
            const annotation = (this.constructor).createAnnotation({ metadata },{
                data: {
                    ...
                    label: '',
                    // Seed the exact stored prompt indices under a key no recompute
                    // path can resolve: updateOpen/ClosedCachedStats stamp every z
                    // with the viewport's current slice, and the refine payload
                    // reads Object.values(...)[0].scribble / .boundary.
