...
from sam2.utils.misc import concat_points, fill_holes_in_mask_scores, load_video_frames, load_medical_slices
...
class SAM2VideoPredictor(SAM2Base):
    ...
    def init_state(
        ...
        images, video_height, video_width = load_medical_slices(
